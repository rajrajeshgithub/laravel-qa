...
{	
	...
	/*$('#addCategory').click(function()
	{
			...
			$('.viewmoreBtn i').closest('.row').find('.viewmorSection').attr( 'style','db' );
	...
	$("#formSection").validate(
		{
			...
			messages:
			{
				...
				C_urlFriendlyName   :{required:"Please enter url friendly name",remote: "URL friendly already in use"},
...
function Hide_NPOCategory()
{
	...
	if(chkValue!=0)
	{
		if(confirm("Are you sure you want to hide this category detail ?")) 
		{
