...
class Npos_Controller extends Controller
{
	...
	private function NPOsList()
	{
		...
		$DataArray	= array('N.NPO_ID','N.NPO_EIN','N.NPO_Name','N.NPO_SubSectionName','N.NPO_City','N.NPO_DedCode','N.NPO_Status','N.NPO_State as State_Name');
		$NPOsList	= $this->objnpos->GetNPOsList_DB($DataArray,$Condition);
		foreach($NPOsList as &$val)
		{
			$val['NPO_SubSectionName']	= str_replace(',',', ',$val['NPO_SubSectionName']);	
		}
	...
	private function FilterData()
	{
		...
		if($SearchCategory !='' && $SearchCategory!= NULL){$ConditionArr[]	= "C.NPOCat_ID  = '".$SearchCategory."'";}
