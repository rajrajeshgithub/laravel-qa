...
class NposProcess_Controller extends Controller
{
	...
	public function NPOsDataInsert()
	{
		...
		{			
			...
			{	
				if($val[33] == 'NEW'){
					$val[33]	= $this->generateuniquecode($val);
				}
				$arrValue = array();
				$Value .= "(";
	...
	private function GetNPOsList() {
		$LimitStr = " LIMIT " . $this->CurrentCsvPosition . "," . $this->ExpCsvLimit;
		$DataArray = array("N.NPO_ID", "N.NPO_EIN", "N.NPO_Name", "N.NPO_ICO", "N.NPO_Street", "N.NPO_City", "N.NPO_State", "N.NPO_Zip", "N.NPO_SubSectionName", "N.NPO_SubSectionDesc", "N.NPO_CD", "N.NPO_Category", "N.NPO_IRS_NTEECode2Description", "N.NPO_Affiliation", "N.NPO_AffType", "N.NPO_IRS_AffiliationCodesDescription", "N.NPO_DedCode", "N.NPO_DedDescription", "N.NPO_FoundationCode", "N.NPO_FoundationDescription", "N.NPO_OrgCode", "N.NPO_OrgDescription", "N.NPO_EO_StatusCode", "N.NPO_EO_Description", "N.NPO_AssetIncomeCode", "N.NPO_IRS_AssetIncomeCodesDescription", "N.NPO_FilingCode", "N.NPO_IRS_FilingCodesDescription", "N.NPO_PF_FilingCode", "N.NPO_IRS_PF_FilingCodesDescription", "N.NPO_AssetAmt", "N.NPO_IncomeAmt", "N.NPO_RevenueAmt", "N.NPO_UniqueCode");
		return $this->objnposprocess->GetNPOsList($DataArray, $LimitStr);	
	}
	...
	public function downloadsamplecsv()
	{
		...
		LoadLib("Download_file");
		$dFile = new Download_file();
		$dFile->Downloadfile($path, "sample.csv", "npo_sample_file");
	}
