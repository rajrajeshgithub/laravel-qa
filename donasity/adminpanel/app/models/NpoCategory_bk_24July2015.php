...
class NpoCategory_Model extends Model
{
	...
	public function CreateCategoryRelationDB($Subsection,$CatID)
	{
		$Sql	= "INSERT INTO ".TBLPREFIX."npocategoryrelation(NPO_CategoryName,NPOCat_ID)
					VALUES ('".$Subsection."','".$CatID."')ON DUPLICATE KEY UPDATE NPO_CategoryName= VALUES(NPO_CategoryName),NPOCat_ID=VALUES(NPOCat_ID)";	
		db::query($Sql);
