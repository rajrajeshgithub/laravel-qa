<?php
	...
	$route['ut1myaccount/deltUnfinishedFundraiser/(:any)/(:any)']  = 'ut1myaccount/deltUnfinishedFundraiser/$1/$2';
	...
	$route['salesubscription/addPaymentDetails']  =   'salesubscription/addPaymentDetails';
	$route['salesubscription/showConfirmation']  =   'salesubscription/showConfirmation';
	$route['salesubscription/showTransactionReceipt/(:any)'] = 'salesubscription/showTransactionReceipt/$1';
	$route['salesubscription/(:any)']  =   'salesubscription/index/$1';
	...
	$route['ut2myaccount/deltUnfinishedFundraiser/(:any)/(:any)']  = 'ut2myaccount/deltUnfinishedFundraiser/$1/$2';
