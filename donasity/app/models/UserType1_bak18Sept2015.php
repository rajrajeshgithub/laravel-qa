<?php
	class UserType1_Model extends Model
	{
		...
		public $FirstName,$LastName,$Address1,$Address2,$City,$State,$Country,$Zip,$PhoneNumber,$Mobile,$EmailAddress,$Password,$ConfirmPassword,$Gender,$UserType,$DOB,
			   $RegDate,$LastLoginDate,$UpdateDate,$Deleted,$UserIP,$Status,$UploadProfileImage,$CompanyName,$Designation,$ExistProfileImg,$UpdatableDataArray;
		...
		public function ValidateLoginRegisterInput()
		{
			...
			if(trim($this->Password)=="") $this->Password="Pass@123";
		}
		...
		public function GetUserDetails($DataArray=array('RU.RU_ID','RU.RU_FistName','RU.RU_LastName','RU.RU_EmailID','RU.RU_ProfileImage','RU.RU_City','RU.RU_ZipCode','RU.RU_Address1','RU.RU_Address2','RU.RU_EmailID'),$Condition=NULL)
		{
			$Fields	= implode(",",$DataArray);
		...
		public function checkLogin($loginDetail)
		{
			...
			{
				if($loginDetail['UserType1']['is_login'] == 1)
				{
