	...
	{		
		...
		public function index($type='detail',$Campaign_ID=1)
		{
			...
			switch(strtolower($type))
			{
				case "campaigncategorylist":
					...
					Initmetadetail($this->tpl,'donationcategory');
		...
		private function CampaignDetail()
		{
			...
			$campaignArray		= array("C.Camp_ID","C.Camp_Title","C.Camp_StartDate","C.Camp_EndDate","C.Camp_CP_City",
											"C.Camp_CP_Email","C.Camp_NPO_EIN","I.Camp_Image_Name","I.Camp_Image_Title");
			$campaignfilter		= array("Camp_ID"=>$this->CI_CID,"Camp_Deleted"=>'0',"Camp_IsPrivate"=>'0',"Camp_Status"=>'1');
