(function(d) {
    ...
    var b = {majorVersion: "3",minorVersion: "4.9",releaseDate: "2012-02-23",_init: function() {
...
(function(a) {
    a.VK = {DELETE: 46,BACKSPACE: 8,ENTER: 13,TAB: 9,SPACEBAR: 32,UP: 38,DOWN: 40,modifierPressed: function(b) {
...
(function(l) {
    ...
    function c(n) {
        ...
        n.onKeyDown.add(function(r, v) {
            ...
            if ((s || v.keyCode == k) && !j.modifierPressed(v)) {
                ...
                r.getDoc().execCommand(s ? "ForwardDelete" : "Delete", false, null);
                x = p.getParent(q.startContainer, p.isBlock);
                l.each(p.select("span.Apple-style-span,font.Apple-style-span", x), function(y) {
                    var z = o.getBookmark();
                    if (u) {
    ...
    function d(n) {
        function o(r) {
            ...
            q.appendChild(s);
            return n.selection.serializer.serialize(q, {format: "html"})
        }
        function p(q) {
            var s = o(q);
    ...
    function e(n) {
        n.onKeyDown.add(function(o, r) {
            if (r.keyCode === k) {
                if (o.selection.isCollapsed() && o.selection.getRng(true).startOffset === 0) {
    ...
    l.create("tinymce.util.Quirks", {Quirks: function(n) {
            if (l.isWebKit) {
                c(n);
                d(n);
                b(n);
...
(function(m) {
    ...
    function a(r, q) {
        ...
        n(q).replace(/#/g, "#text").replace(/(\w+)\[([^\]]+)\]\[([^\]]*)\]/g, function(v, t, s, u) {
            s = i(s, "|");
            p[t] = {attributes: d(s),attributesOrder: s,children: d(u, "|", {"#comment": {}})}
        });
        return p
    }
    ...
    m.html.Schema = function(r) {
            ...
            if (I) {
                ...
                for (H = 0, D = I.length; H < D; H++) {
                    ...
                    if (C) {
                        ...
                        L = {};
                        G = [];
                        F = {attributes: L,attributesOrder: G};
                        if (T === "#") {
                            F.paddEmpty = true
                        }
                        if (T === "-") {
                                ...
                                if (C) {
                                    ...
                                    if (T) {
                                        if (T === "=") {
                                            ...
                                            F.attributesDefault.push({name: V,value: Q});
                                            R.defaultValue = Q
                                        }
                                        if (T === ":") {
                                            F.attributesForced = F.attributesForced || [];
                                            F.attributesForced.push({name: V,value: Q});
                                            R.forcedValue = Q
                                        }
                                        if (T === "<") {
                                            R.validValues = d(Q, "?")
        ...
        function s(C) {
            ...
            if (C) {
                k(i(C), function(G) {
                    var E = B.exec(G), F = E[1] === "~", H = F ? "span" : "div", D = E[2];
                    o[D] = o[H];
                    c[D] = H;
                    if (!F) {
                        l[D] = {}
        ...
        if (!r.valid_elements) {
            k(h, function(C, B) {
                n[B] = {attributes: C.attributes,attributesOrder: C.attributesOrder};
                o[B] = C.children
            });
            ...
            n.img.attributesDefault = [{name: "alt",value: ""}];
            k(i("ol,ul,sub,sup,blockquote,span,font,a,table,tbody,tr"), function(B) {
                n[B].removeEmpty = true
            });
            k(i("p,h1,h2,h3,h4,h5,h6,th,td,pre,div,address,caption"), function(B) {
                n[B].paddEmpty = true
            })
        } else {
            v(r.valid_elements)
...
(function(a) {
    a.html.SaxParser = function(c, e) {
        ...
        b.parse = function(D) {
            ...
            l = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([^\\s\\/<>]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/)>))", "g");
            C = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:\\.|[^\"])*)\")|(?:\'((?:\\.|[^\'])*)\')|([^>\s]+)))?/g;
...
(function(h) {
    ...
    h.create("tinymce.dom.DOMUtils", {doc: null,root: null,files: null,pixelStyles: /^(top|left|bottom|right|width|height|borderWidth)$/,props: {"for": "htmlFor","class": "className",className: "className",checked: "checked",disabled: "disabled",maxlength: "maxLength",readonly: "readOnly",selected: "selected",value: "value",id: "id",name: "name",type: "type"},DOMUtils: function(o, m) {
            var l = this, j, k;
            l.doc = o;
            l.win = window;
            l.files = {};
            ...
            l.settings = m = h.extend({keep_values: false,hex_colors: 1}, m);
            l.schema = m.schema;
            l.styles = new h.html.Styles({url_converter: m.url_converter,url_converter_scope: m.url_converter_scope}, m.schema);
            if (h.isIE6) {
                try {
                ...
                if (j !== null) {
                    switch (m) {
                        case "style":
                            ...
                            if (p.keep_values) {
                                if (j && !k._isRes(j)) {
                                    q.setAttribute("data-mce-style", j, 2)
                                } else {
                                    q.removeAttribute("data-mce-style", 2)
                                }
                            }
                            q.style.cssText = j;
                            break;
                        ...
                        case "href":
                            if (p.keep_values) {
                                if (p.url_converter) {
                                    j = p.url_converter.call(p.url_converter_scope || k, j, m, q)
                                }
                                k.setAttrib(q, "data-mce-" + m, j, 2)
                            }
                            break;
                        case "shape":
            ...
            function k(x) {
                ...
                if (v != 9) {
                    if (v == 3 && x.nodeValue.length > 0) {
                        ...
                        if (!s.isBlock(x.parentNode) || r > 0 || r == 0 && y(x)) {
                            return
                        }
                    } else {
                        if (v == 1) {
                            t = x.childNodes;
                            if (t.length == 1 && t[0] && t[0].nodeType == 1 && t[0].getAttribute("data-mce-type") == "bookmark") {
                                x.parentNode.insertBefore(t[0], x)
                            }
                            if (t.length || /^(br|hr|input|img)$/i.test(x.nodeName)) {
                                return
                            }
                        }
                    }
...
(function(n) {
    ...
    n.create("tinymce.Editor", {Editor: function(u, r) {
            ...
            var D = this, u, E = D.settings, r = D.dom, y = {mouseup: "onMouseUp",mousedown: "onMouseDown",click: "onClick",keyup: "onKeyUp",keydown: "onKeyDown",keypress: "onKeyPress",submit: "onSubmit",reset: "onReset",contextmenu: "onContextMenu",dblclick: "onDblClick",paste: "onPaste"};
            function q(t, F) {
                var s = t.type;
                if (D.removed) {
                    return
                ...
                if (D.onEvent.dispatch(D, t, F) !== false) {
                    D[y[t.fakeType || t.type]].dispatch(D, t, F)
                }
            }
            i(y, function(t, s) {
                switch (s) {
                    ...
                    case "submit":
                    case "reset":
                        r.bind(D.getElement().form || o.getParent(D.id, "form"), s, q);
                        break;
                    default:
                        r.bind(E.content_editable ? D.getBody() : D.getDoc(), s, q)
                }
            });
            r.bind(E.content_editable ? D.getBody() : (a ? D.getDoc() : D.getWin()), "focus", function(s) {
                D.focus(true)
            });
            if (n.isGecko) {
                r.bind(D.getDoc(), "DOMNodeInserted", function(t) {
                    var s;
                    t = t.target;
                    if (t.nodeType === 1 && t.nodeName === "IMG" && (s = t.getAttribute("data-mce-src"))) {
                        t.src = D.documentBaseURI.toAbsolute(s)
                    }
                })
            }
            if (a) {
                function v() {
                    ...
                    if (a && !H.readonly) {
                        ...
                        try {
                            I.execCommand("styleWithCSS", 0, false)
                        } catch (F) {
                            if (!G._isHidden()) {
                                try {
                                    I.execCommand("useCSS", 0, true)
                                } catch (F) {
                                }
                            }
                        }
                        if (!H.table_inline_editing) {
                            try {
                                I.execCommand("enableInlineTableEditing", false, false)
                            } catch (F) {
                            }
                        }
                        if (!H.object_resizing) {
                            try {
                                I.execCommand("enableObjectResizing", false, false)
                            } catch (F) {
                            }
                        }
                    }
            ...
            D.onKeyUp.add(function(s, t) {
                var F = t.keyCode;
                if ((F >= 33 && F <= 36) || (F >= 37 && F <= 40) || F == 13 || F == 45 || F == 46 || F == 8 || (n.isMac && (F == 91 || F == 93)) || t.ctrlKey) {
                    D.nodeChanged()
                }
            });
            D.onKeyDown.add(function(t, F) {
                ...
                var G = s.startOffset;
                while (H && H.nodeType && H.nodeType != 1 && H.parentNode) {
                    H = H.parentNode
                }
                if (H && H.parentNode && H.parentNode.tagName === "BLOCKQUOTE" && H.parentNode.firstChild == H && G == 0) {
                    t.formatter.toggle("blockquote", null, H.parentNode);
                    s.setStart(H, 0);
                    s.setEnd(H, 0);
            ...
            D.onReset.add(function() {
                D.setContent(D.startContent, {format: "raw"})
            });
            if (E.custom_shortcuts) {
                if (E.custom_undo_redo_keyboard_shortcuts) {
                    D.addShortcut("ctrl+z", D.getLang("undo_desc"), "Undo");
                ...
                for (u = 1; u <= 6; u++) {
                    D.addShortcut("ctrl+" + u, "", ["FormatBlock", false, "h" + u])
                }
                ...
                function x(t) {
                    ...
                    i(D.shortcuts, function(F) {
                        if (n.isMac && F.ctrl != t.metaKey) {
                            return
                        } else {
                            if (!n.isMac && F.ctrl != t.ctrlKey) {
                                return
                            }
                        }
                        if (F.alt != t.altKey) {
                        ...
                        if (t.keyCode == F.keyCode || (t.charCode && t.charCode == F.charCode)) {
                            s = F;
                            return false
                        }
                    });
            ...
            if (n.isIE) {
                r.bind(D.getDoc(), "controlselect", function(F) {
                    ...
                    if (!r.hasClass(F, "mceItemNoResize")) {
                        ev = "resizeend";
                        s = r.bind(F, ev, function(H) {
                            var G;
                            H = H.target;
                            if (G = r.getStyle(H, "width")) {
                                r.setAttrib(H, "width", G.replace(/[^0-9%]+/g, ""));
                                r.setStyle(H, "width", "")
                            }
                            if (G = r.getStyle(H, "height")) {
                                r.setAttrib(H, "height", G.replace(/[^0-9%]+/g, ""));
                                r.setStyle(H, "height", "")
                            }
                        })
                    } else {
                        ev = "resizestart";
                        s = r.bind(F, "resizestart", k.cancel, k)
                    }
                    t = D.resizeInfo = {node: F,ev: ev,cb: s}
                })
            }
            if (n.isOpera) {
            ...
            if (E.custom_undo_redo) {
                ...
                D.dom.bind(D.dom.getRoot(), "dragend", function(s) {
                    A()
                });
                D.onKeyUp.add(function(s, F) {
                    var t = F.keyCode;
                    if ((t >= 33 && t <= 36) || (t >= 37 && t <= 40) || t == 13 || t == 45 || F.ctrlKey) {
                        A()
                    }
                });
                D.onKeyDown.add(function(s, G) {
                    var F = G.keyCode, t;
                    if (F == 8) {
                    ...
                    if ((F >= 33 && F <= 36) || (F >= 37 && F <= 40) || F == 13 || F == 45) {
                        if (n.isIE && F == 13) {
                            D.undoManager.beforeChange()
                        }
                    ...
                    if ((F < 16 || F > 20) && F != 224 && F != 91 && !D.undoManager.typing) {
                        D.undoManager.beforeChange();
            ...
            if (n.isGecko) {
                function C() {
                    var s = D.dom.getAttribs(D.selection.getStart().cloneNode(false));
                    return function() {
                        var t = D.selection.getStart();
                        if (t !== D.getBody()) {
                            D.dom.setAttrib(t, "style", null);
                            i(s, function(F) {
                                t.setAttributeNode(F.cloneNode(true))
                            })
                        }
                    }
                }
...
(function(a) {
    a.Formatter = function(V) {
        var M = {}, P = a.each, c = V.dom, q = V.selection, t = a.dom.TreeWalker, K = new a.dom.RangeUtils(c), d = V.schema.isValidChild, F = c.isBlock, l = V.settings.forced_root_block, s = c.nodeIndex, E = "\uFEFF", e = /^(src|href|style)$/, S = false, B = true, p;
        function z(W) {
        ...
        function T(Z, ag, ab) {
            ...
            function aa() {
                ...
                if (ap != ak && al.endOffset == 0) {
                    var ao = am(ap, ak);
                    var an = ao.nodeType == 3 ? ao.length : ao.childNodes.length;
                    al.setEnd(ao, an)
                }
                return al
            }
            function Y(an, at, aq, ap, al) {
                ...
                P(an.childNodes, function(ax, aw) {
                    if (ax.nodeName === "SPAN" && c.getAttrib(ax, "data-mce-type") == "bookmark") {
            ...
            function ai(al, an, ap) {
                ...
                K.walk(al, function(aq) {
                    ...
                    function at(au) {
                        ...
                        if (ah.selector) {
                            P(ac, function(ay) {
                                if ("collapsed" in ay && ay.collapsed !== ad) {
                                    return
                                }
                        ...
                        if (d(ao, ax) && d(aw, ao) && !(!ap && au.nodeType === 3 && au.nodeValue.length === 1 && au.nodeValue.charCodeAt(0) === 65279) && !b(au)) {
                            if (!ar) {
                                ar = am.cloneNode(S);
            ...
            if (ah) {
                if (ab) {
                    ...
                    if (!ad || !ah.inline || c.select("td.mceSelected,th.mceSelected").length) {
                        var aj = V.selection.getNode();
                        V.selection.setRng(aa());
                        af = q.getBookmark();
                        ai(o(q.getRng(B), ac), af);
                        if (ah.styles && (ah.styles.color || ah.styles.textDecoration)) {
        ...
        function A(Y, ag, aa) {
            ...
            function aj(ak) {
                ...
                if (ai.split) {
                    ...
                    am = J(ak);
                    if (al != am) {
                        al = O(al, "span", {id: "_start","data-mce-type": "bookmark"});
                        am = O(am, "span", {id: "_end","data-mce-type": "bookmark"});
                        ah(al);
                        ah(am);
                        al = ad(B);
                        am = ad()
                ...
                K.walk(ak, function(an) {
                    P(an, function(ao) {
                        Z(ao);
                        if (ao.nodeType === 1 && V.dom.getStyle(ao, "text-decoration") === "underline" && ao.parentNode && i(ao.parentNode) === "underline") {
                            U({deep: false,exact: true,inline: "span",styles: {textDecoration: "underline"}}, null, ao)
                        }
                    })
                })
            }
            ...
            if (!q.isCollapsed() || !ai.inline || c.select("td.mceSelected,th.mceSelected").length) {
                af = q.getBookmark();
                aj(q.getRng(B));
                q.moveToBookmark(af);
        ...
        function o(W, ai, Z) {
            ...
            if (ai[0].inline || ai[0].block_expand) {
                ...
                if (!ai[0].inline || (al.nodeType != 3 || af === al.nodeValue.length)) {
                    al = aj()
                }
            }
                ...
                function aa(an, am) {
                    ...
                    for (ap = 0; ap < ao.length; ap++) {
                        for (ar = 0; ar < ai.length; ar++) {
                            aq = ai[ar];
                            if ("collapsed" in aq && aq.collapsed !== W.collapsed) {
                                continue
                            }
            ...
            if (ai[0].block || ai[0].selector) {
                function X(an, am, ap) {
                    ...
                    if (!ao) {
                        ao = c.getParent(an.nodeType == 3 ? an.parentNode : an, F)
                    }
                    if (ao && ai[0].wrapper) {
            ...
            return {startContainer: Y,startOffset: ad,endContainer: al,endOffset: af}
        }
        ...
        function Q(af, W, ad) {
            ...
            ai = a.isGecko ? "\u200B" : E;
            function Y(ak) {
                var aj = c.create("span", {id: ag,"data-mce-bogus": true,style: X ? "color:red" : ""});
                if (ak) {
            ...
            function ae(ak, aj) {
                while (ak) {
                    if ((ak.nodeType === 3 && ak.nodeValue !== ai) || ak.childNodes.length > 1) {
                        return false
                    }
                    if (aj && ak.nodeType === 1) {
                        aj.push(ak)
